package com.example.shaadicloneapp.utils
...
class SliderLayoutManager(context: Context?) : LinearLayoutManager(context) {
    ...
    var callbackDrag: OnDragListener? = null
...
//            Timber.d("Minimum distance: $minDistance")
            var position = -1
...
//                    Timber.d("New Distance: $newDistance")
                }
            }
        ...
        if(state.equals(RecyclerView.SCROLL_STATE_DRAGGING)){
            callbackDrag?.onDragging()
        }
    }
